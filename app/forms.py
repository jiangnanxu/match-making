...
class RegistrationForm(FlaskForm):
	...
	height = IntegerField('Height', validators=[DataRequired(),number_range(min=100, max=300)])
...
class PreferencesForm(FlaskForm):
	perfheight = SelectField('height preference', choices=[('Any','Any'), ('Higher', 'Higher'), ('Lower', 'Lower')])
