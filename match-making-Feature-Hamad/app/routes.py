...
from app.forms import RegistrationForm, LoginForm, UpdateAccountForm, PreferencesForm, deleteUserForm
...
def preferences():
    ...
    if form.validate_on_submit():
        ...
        preferences = Preferences(prefage=form.p_age.data, prefcity=form.prefcity.data, prefpersonality=form.prefpersonality.data, prefeducation=form.prefeducation.data)
